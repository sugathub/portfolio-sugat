...
const Testimonials = () => {
  return (
    ...
    <section className='relative min-h-screen bg-black text-white flex flex-col items-center justify-between px-6 py-20  ' >
        ...
        animate ={{opacity:1,y:0}}
         ...
         <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 max-w-6xl w-full ' >
          ...
          {testimonials.map((t,i)=>(
            ...
            viewport={{once:true}}
            className='bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl flex flex-col items-center text-center transition duration-500 
            hover:scale-105 haver:-rotate-1 '
            >
